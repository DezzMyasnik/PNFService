    ...
    public partial class Service1 : ServiceBase
    {
        ...
        private void SuitcaseProcess()
        {
            ...
            try
            {
                ...
                if (last_outer_ID != String.Empty)  //если данные из большой БД пришли, то запускаем парсинг json, разбор полученных данных
                {
        ...
        {
           // eventLog1.WriteEntry("1"+ Properties.Settings.Default.PackflyConnStr, EventLogEntryType.Information, 406);
            ...
            {
                //eventLog1.WriteEntry("2 " + Properties.Settings.Default.PackflyConnStr+ " "+ ID_Machina+adress, EventLogEntryType.Information, 406);
                string pass = GetDBPass(adress, ID_Machina);
                //eventLog1.WriteEntry(pass, EventLogEntryType.Information, 400);
                //string pass = "hF93-DY89s8";
                ...
                {
                    Send_sate_of_service(ID_Machina, adress, 5);
                    eventLog1.WriteEntry("Пароль не получен", EventLogEntryType.Information, 402);
                }
            }
            else
            {
                //eventLog1.WriteEntry("3" + Properties.Settings.Default.PackflyConnStr, EventLogEntryType.Information, 406);
                if (InitConection())
                {
                    ...
                    //eventLog1.WriteEntry(ver);
                    //eventLog1.WriteEntry(fvi.FileVersion);
                }
                else
                {
                    Send_sate_of_service(ID_Machina, adress, 4);
